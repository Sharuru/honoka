                ...
                <c:if test="${pageParaMap.poiSearchList != null && pageParaMap.poiSearchList.size() > 0}">
                    ...
                    <div class="list-group">
                      <a href="#" class="list-group-item">
                            <h5 class="list-group-item-heading"><span class="glyphicon glyphicon-map-marker" aria-hidden="true"></span>&nbsp;${currPOI.poiName}</h5>
                            <p class="list-group-item-text" style="font-size: 15px">${currPOI.poiAddr}</p>

...
/*		//public String getInfo() {
    ...
    // Direction API Transit POJO
    public static class BaiduJsonDirectionTransit {
        // 状态码
        Integer status;
        // 状态码对应信息
        String message;
        ...
        Integer type;
        // 返回的结果
        BaiduDirectionTransitResult result;
        ...
        public BaiduDirectionTransitResult getResult() {
            return result;
        }

        public void setResult(BaiduDirectionTransitResult result) {
            this.result = result;
        }
    }

    public static class BaiduDirectionTransitResult {
        BaiduDirectionTransitRoutes[] routes;

        public BaiduDirectionTransitRoutes[] getRoutes() {
            return routes;
        }

        public void setRoutes(BaiduDirectionTransitRoutes[] routes) {
            this.routes = routes;
        }
    }

    public static class BaiduDirectionTransitRoutes {
        BaiduDirectionTransitScheme[] scheme;

        public BaiduDirectionTransitScheme[] getScheme() {
            return scheme;
        }

        public void setScheme(BaiduDirectionTransitScheme[] scheme) {
            this.scheme = scheme;
        }
    }

    public static class BaiduDirectionTransitScheme {
        // 方案距离
        Integer distance;
        // 线路耗时
        Integer duration;
